...
function getSelectionFunction(str) {
    switch (str) {
        case 'proportional': return proportionalSelection;
        case 'random': return randomSelection;
        case 'tournament': return tournamentSelection;
        default: return proportionalSelection;
    }
}

function getReplacementFunction(str) {
    switch (str) {
        case 'complete': return completeReplacement;
        case 'random': return randomReplacement;
        case 'elitism': return elitismReplacement;
